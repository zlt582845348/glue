 ...
 * @author Ryan.Tang
 */
public class MipcaActivityCapture extends Activity implements Callback, MipcaCapture {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(ViewUtil.getResId(getApplication(), "layout", "activity_capture"));
		//ViewUtil.addTopView(getApplicationContext(), this, R.string.scan_card);
		CameraManager.init(getApplication());
		viewfinderView = (ViewfinderView) findViewById(ViewUtil.getResId(getApplication(), "id","viewfinder_view"));
		
		Button mButtonBack = (Button) findViewById(ViewUtil.getResId(getApplication(), "id","button_back"));
	...
	protected void onResume() {
		super.onResume();
		SurfaceView surfaceView = (SurfaceView) findViewById(ViewUtil.getResId(getApplication(), "id","preview_view"));
	...
	public void initBeepSound() {
		if (playBeep && mediaPlayer == null) {
			...
			AssetFileDescriptor file = getResources().openRawResourceFd(
					ViewUtil.getResId(getApplication(), "raw","beep"));
			try {
